...
export class OrdersComponent implements OnInit {
  ...
  submit(){
    ...
    if (this.name === ''){
      ...
      this.errorMessage = 'Name must not be empty!'; //Name input field not specified
      error = true;
    } else if(commaIndex === -1){
      this.errorMessage = 'Name must have a comma and a space between first and last name!'; //Name not containing a “, ”.
      error = true;
    }
    ...
    this.totalsMessage= '${total}';
    this.confirmMessage = `Thank you ${fullName}. Here are your order details! Your sub total is: ${calculation.subTotal}. Your tax amount is ${calculation.taxAmount}. Your grand total is ${calculation.total}.`;
    this.flexModal.openDialog('confirm-modal');
  } else {
      this.flexModal.openDialog('error-modal');
    }
    //console.log('this.name', this.name, 'commaIndex', commaIndex, 'firstName', firstName, 'lastName', lastName, 'fullName', fullName);
 ...
 // display the order form with orders from orders.json
  ...
  firstName(arg0: string, name: string, arg2: string, commaIndex: number, arg4: string, firstName: any, arg6: string, lastName: any, arg8: string, fullName: any) {
    throw new Error('Function not implemented.');
  }

  lastName(arg0: string, name: string, arg2: string, commaIndex: number, arg4: string, firstName: any, arg6: string, lastName: any, arg8: string, fullName: any) {
    throw new Error('Function not implemented.');
  }

  fullName(arg0: string, name: string, arg2: string, commaIndex: number, arg4: string, firstName: any, arg6: string, lastName: any, arg8: string, fullName: any) {
    throw new Error('Function not implemented.');
  }
